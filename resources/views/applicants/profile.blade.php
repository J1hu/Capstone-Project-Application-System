    ...
    <div class="my-4 border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
            ...
            <li role="presentation">
                <button
                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-blue-500 hover:border-blue-300 dark:hover:text-blue-300"
                    id="sign-tab" data-tabs-target="#sign" type="button" role="tab"
                    aria-controls="sign" aria-selected="false">Signed Declaration</button>
            </li>
        </ul>
    </div>
    <div id="myTabContent">
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
            ...
            <div class="grid grid-cols-4">
                ...
                <div class="col-span-3">
                    ...
                    <a href="https://{{ $user->applicant->fb_link }}"
                        class="text-blue-500">{{ $user->applicant->fb_link }}</a>
                    <p class="capitalize">{{ $applicant->address->street }}, {{ $applicant->address->barangay }},
                        {{ $applicant->address->city_municipality }}, {{ $applicant->address->province }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <p class="capitalize">{{ $user->applicant->mother->mother_fname }} {{ $user->applicant->mother->mother_mname }}
                            {{ $user->applicant->mother->mother_lname }}</p>
                ...
                <div class="grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <p class="capitalize">{{ $user->applicant->father->father_fname }} {{ $user->applicant->father->father_mname }}
                            {{ $user->applicant->father->father_lname }}</p>
                ...
                <div class="grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <p class="capitalize">{{ $user->applicant->guardian->guardian_fname }}
                            ...
                            {{ $user->applicant->guardian->guardian_lname }}</p>
        ...
        <div class="hidden space-y-4" id="others" role="tabpanel"
            ...
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                <div class="grid grid-cols-4">
                        ...
                        <div class="col-span-3">
                            ...
                            <p class="capitalize">{{ $user->applicant->monthly_rental }}</p>
                        </div>
                </div>
            </div>
        </div>
        <div class="hidden" id="sign" role="tabpanel"
