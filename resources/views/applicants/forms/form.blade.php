    ...
    <div class="flex items-center justify-center h-screen">
        <form method="POST" action="{{ route('applicants.store') }}" enctype="multipart/form-data"
            ...
            <div id="section-1" class="section">
                ...
                <div class="grid">
                    <button type="button"
                        class="next-btn justify-self-end bg-blue-500 px-10 py-2 border-2 w-1/4 rounded-md border-slate-300 text-white"
            ...
            <div id="section-2" class="section">
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div>
                            <label for="applicant_type" class="text-sm text-slate-700">Applicant Type<span
                                    class="text-red-500"> *</span></label>
                            <select name="applicant_type" id="applicant_type" required="required"
                                class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            <label for="phone_num" class="text-sm text-slate-700">Phone Number<span
                                    class="text-red-500"> *</span></label>
                        ...
                        <div>
                            <label for="fb_link" class="text-sm text-slate-700">Facebook Link<span
                                    class="text-red-500"> *</span></label>
                    ...
                    <div class="my-5">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label for="province" class="text-sm text-slate-700">Province Address<span
                                        class="text-red-500"> *</span></label>
                            ...
                            <div>
                                <label for="barangay" class="text-sm text-slate-700">Barangay<span
                                        class="text-red-500"> *</span></label>
                            ...
                            <div>
                                <label for="street" class="text-sm text-slate-700">Street<span
                                        class="text-red-500"> *</span></label>
                            ...
                            <div>
                                <label for="zip_code" class="text-sm text-slate-700">Zip Code<span
                                        class="text-red-500"> *</span></label>
            ...
            <div id="section-3" class="section">
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    <div class="text-center my-5">
                        ...
                        <p><span class="font-bold">Note: </span>If NOT APPLICABLE, write<span
                                class="text-red-500 font-bold"> None</span>.</p>
                    </div>
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            ...
                            <input type="number" name="total_fam_children" id="total_fam_children"
                                value="{{ old('total_fam_children') }}" min="1" max="20" required
                                class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            <label for="birth_order" class="text-sm text-slate-700">Birth Order of the Applicant<span
                                    class="text-red-500"> *</span></label>
                            <input type="number" name="birth_order" id="birth_order"
                                value="{{ old('birth_order') }}" min="1" max="20" required
                                class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                    ...
                    <div class="my-5 space-y-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-6">
                                <div>
                                    <label for="full_name[]" class="text-sm text-slate-700">Name<span
                                            class="text-red-500"> *</span></label>
                    ...
                    <div class="my-5 space-y-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-6">
                                <div>
                                    <label for="mother_fname" class="text-sm text-slate-700">Firstname<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="mother_religion" class="text-sm text-slate-700">Religion<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="mother_occupation" class="text-sm text-slate-700">Occupation<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    ...
                                    <select name="mother_annual_income" id="mother_annual_income" required="required"
                                        class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                ...
                                <div>
                                    <label for="mother_phone_num" class="text-sm text-slate-700">Phone Number<span
                                            class="text-red-500"> *</span></label>
                                    <input type="number" name="mother_phone_num" id="mother_phone_num"
                                        value="{{ old('mother_phone_num') }}" required minlength="11" maxlength="11"
                                        class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-6">
                                <div>
                                    <label for="father_fname" class="text-sm text-slate-700">Firstname<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="father_religion" class="text-sm text-slate-700">Religion<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="father_mname" class="text-sm text-slate-700">Middle Name<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="father_occupation" class="text-sm text-slate-700">Occupation<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="father_lname" class="text-sm text-slate-700">Last Name<span
                                            class="text-red-500"> *</span></label>
                                ...
                                <div>
                                    <label for="father_annual_income" class="text-sm text-slate-700">Annual
                                        Income<span class="text-red-500">*</span></label>
                                    <select name="father_annual_income" id="father_annual_income" required="required"
                                        class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                ...
                                <div>
                                    <label for="father_phone_num" class="text-sm text-slate-700">Phone Number<span
                                            class="text-red-500"> *</span></label>
                                    <input type="number" name="father_phone_num" id="father_phone_num"
                                        value="{{ old('father_phone_num') }}" required minlength="11" maxlength="11"
                                        class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-x-6">
                                    <div>
                                        <label for="guardian_fname" class="text-sm text-slate-700">Firstname<span
                                                class="text-red-500"> *</span></label>
                                    ...
                                    <div>
                                        <label for="guardian_religion" class="text-sm text-slate-700">Religion<span
                                                class="text-red-500"> *</span></label>
                                    ...
                                    <div>
                                        <label for="guardian_mname" class="text-sm text-slate-700">Middle Name<span
                                    ...
                                    <div>
                                        <label for="guardian_occupation"
                                            class="text-sm text-slate-700">Occupation<span class="text-red-500">
                                                *</span></label>
                                    ...
                                    <div>
                                        <label for="guardian_lname" class="text-sm text-slate-700">Last Name<span
                                                class="text-red-500"> *</span></label>
                                    ...
                                    <div>
                                        <label for="guardian_annual_income" class="text-sm text-slate-700">Annual
                                            Income<span class="text-red-500"> *</span></label>
                                        <select required="required" name="guardian_annual_income" id="guardian_annual_income"
                                            class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                            <option value="" disabled selected hidden>Select Annual Income Range
                                            </option>
                                            <option value="no income">No Income</option>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="guardian_phone_num" id="guardian_phone_num"
                                            value="{{ old('guardian_phone_num') }}" required minlength="11"
                                            maxlength="11"
                                            class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
            ...
            <div id="section-4" class="section">
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            <label for="last_school" class="text-sm text-slate-700">Last School Attended<span
                                    class="text-red-500"> *</span></label>
                        ...
                        <div>
                            <label for="school_type" class="text-sm text-slate-700">School Type<span
                                    class="text-red-500"> *</span></label>
                            <select required="required" name="school_type" id="school_type"
                                class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            ...
                            <input type="number" name="lrn" id="lrn" min="0"
                        ...
                        <div>
                            ...
                            <select required="required" name="esc_grantee" id="esc_grantee"
                                class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            ...
                            <input type="number" name="esc_num" id="esc_num" value="{{ old('esc_num') }}"
                                class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                    ...
                    {{-- Upload report card --}}
                    <div class="my-5">
                        <label for="report_card" class="text-lg font-bold">Upload Image of the following<span
                                class="text-red-500"> *</span></label>
                        <ul class="text-slate-700 text-sm list-disc list-inside">
            ...
            <div id="section-5" class="section">
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    ...
                    <div>
                        <label for="program_id" class="text-sm text-slate-700">Program Choice<span
                                class="text-red-500"> *</span></label>
                        <select name="program_id" id="program_id" required="required"
                            class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            <label for="electric_month_1" class="text-sm text-slate-700">Month 1<span
                                    class="text-red-500"> *</span></label>
                            <select required="required" name="electric_bills[0][electric_month]"
                                id="electric_month_1"class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                        ...
                        <div>
                            <label for="electric_month_2" class="text-sm text-slate-700">Month 2<span
                                    class="text-red-500"> *</span></label>
                            <select required="required" name="electric_bills[1][electric_month]"
                                id="electric_month_2"class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                <option value="" disabled selected hidden>Select a month</option>
                                <option value="january">January</option>
                                <option value="february">February</option>
                                <option value="march">March</option>
                        ...
                        <div>
                            <label for="electric_month_3" class="text-sm text-slate-700">Month 3<span
                                    class="text-red-500"> *</span></label>
                            <select required="required" name="electric_bills[2][electric_month]" id="electric_month_3"
                                class="form-control inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                <option value="" disabled selected hidden>Select a month</option>
                                <option value="january">January</option>
                                <option value="february">February</option>
