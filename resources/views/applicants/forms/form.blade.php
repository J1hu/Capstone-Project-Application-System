                ...
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    ...
                    <div>
                        <div>
                            ...
                            <div class="mb-5">
                                <input type="checkbox" name="contact_consent" id="contact_consent" value="1" {{ old('contact_consent') ? 'checked' : '' }}>
                    ...
                    <div class="my-5 space-y-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-6">
                                ...
                                <div>
                                    <label for="mother_annual_income" class="text-sm text-slate-700">Annual Income</label>
                                    <select name="mother_annual_income" id="mother_annual_income" class="inline-flex items-center my-1 p-3 text-sm leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500 w-full">
                                        ...
                                        <option value="2,000,000PHP to 8,000,000PHP">2,000,000PHP to 8,000,000PHP</option>
                                    </select>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-6">
                                ...
                                <div>
                                    <label for="father_annual_income" class="text-sm text-slate-700">Annual Income</label>
                        ...
                        <div>
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-x-6">
                                    ...
                                    <div>
                                        <label for="guardian_mname" class="text-sm text-slate-700">Middle Name: (Maiden
                                            Name)</label>
                                    ...
                                    <div>
                                        <label for="guardian_annual_income" class="text-sm text-slate-700">Annual Income</label>
                                    ...
                                    <div>
                                        <label for="guardian_phone_num" class="text-sm text-slate-700">Phone Number</label>
                            ...
                            {{-- Upload certificate --}}
                            <div class="my-5">
                                <label for="certificate" class="text-lg font-bold">Upload a PDF file of one of the following:</label>
            ...
            <div id="section-6" class="section">
                <div class="bg-white py-5 px-10 border rounded-md mx-auto mt-10 mb-3">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div>
                            <label for="electric_amount_1" class="text-sm text-slate-700">Electric Bill for Month 1:</label>
                        ...
                        <div>
                            <label for="electric_amount_2" class="text-sm text-slate-700">Electric Bill for Month 2:</label>
                        ...
                        <div>
                            <label for="electric_amount_3" class="text-sm text-slate-700">Electric Bill for Month 3:</label>
                    ...
                    <div class="mt-5">
                        <label for="free_ebill_reason" class="text-sm text-slate-700">If your electric consumption is free,
                    ...
                    <div class="my-5 space-y-2">
                        ...
                        <div>
                            <label for="monthly_rental" class="mx-2">If you're renting, please enter monthly rental fee:</label>
