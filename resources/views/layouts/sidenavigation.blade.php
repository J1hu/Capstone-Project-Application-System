<nav x-data="open"
    class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 w-1/4 h-screen fixed top-20">
    <div class="grid mx-7 py-10">
        ...
        @hasrole('applicant')
            ...
            {{-- <x-nav-link :href="route('applicants.profile', ['id' => $user->id])" :active="request()->routeIs('applicants.profile') || strpos(url()->current(), 'applicants.profile') !== false">
