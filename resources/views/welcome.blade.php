<x-body>
        ...
        <div class="absolute top-20 p-5 left-5 right-10 bg-white bg-opacity-80 text-blue-800 text-left md:w-3/4 lg:w-2/3 xl:w-1/2 md:left-10 lg:top-15 lg:left-20">
            ...
            <div class="text-center flex items-center justify-center sm:justify-start">
                <a href="{{ route('register') }}">
                    <div class="w-auto text-center py-2 px-10 font-bold rounded-sm text-sm text-white transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-blue-700 duration-300 hover:text-white">
    ...
    <div class="h-fit lg:h-96 bg-indigo-700">
        <div class="h-full relative grid grid-cols-1 gap-4 content-center w-auto text-center px-5 md:px-10">
            <div class="mt-10 border-dashed border-slate-300 rotate-6 w-8 h-8 border-2 sm:w-10 sm:h-10 md:w-12 md:h-12 md:border-4 lg:w-14 lg:h-14 lg:mt-24 xl:ml-14">
            </div>
            <div class="mt-7 absolute right-10 float-right border-slate-300 rotate-45 w-5 h-5 border-2 sm:w-7 sm:h-7 md:w-9 md:h-9 md:border-4 lg:w-12 lg:h-12 lg:mt-16 xl:mr-14">
            </div>
            ...
            <div class="mb-10 border-double border-slate-300 rotate-45 w-9 h-9 border-4 sm:w-10 sm:h-10 md:w-12 md:h-12 md:border-6 lg:w-14 lg:h-14 lg:mb-24 lg:ml-10">
            </div>
            <div class="absolute bottom-5 right-10 border-dotted border-slate-300 rotate-12 w-5 h-5 border-2 sm:w-7 sm:h-7 md:w-9 md:h-9 lg:border-4 lg:w-12 lg:h-12 lg:mb-16 lg:mr-14">
            </div>
        </div>
    </div>
    {{-- To Prepare --}}
    <div class="h-fit my-10 md:h-screen md:my-0 lg:h-fit lg:my-14">
        <div class="h-full grid grid-cols-1 gap-4 content-center w-auto text-center md:flex md:flex-row md:items-center md:align-middle md:my-auto md:mx-10">
            ...
            <div class="mx-auto text-center flex items-center justify-center w-5/6 h-72 sm:my-15 md:basis-1/2 md:h-64 md:w-9/12 lg:h-96">
    ...
    <div class="h-fit my-10 lg:my-36">
        <div class="grid gap-4 mb-4 md:grid-flow-row md:grid-cols-2 md:gap-0">
            ...
            <x-perks-card edits="w-5/6" title="No Miscellaneous & Tuition Fees" desc="Full Scholar students are offered a no charge fees on any school expenses and as well as their tuition fees.">
            </x-perks-card>
        </div>
        <div class="grid gap-4 mb-4 md:grid-flow-row md:grid-cols-3 md:gap-0">
            <x-perks-card edits="w-5/6" title="Free Uniform" desc="Full Scholar students are granted with a free uniform for their regular classes days as well as free P.E uniform for their sports and physical activities.">
            </x-perks-card>
            <x-perks-card edits="w-5/6" title="Free Food" desc="Full Scholar students are granted with a free lunch everyday depends on their schedule.">
            </x-perks-card>
            <x-perks-card edits="w-5/6" title="Free Books" desc="Full Scholar students are granted with a free access of books in the LVCC Library.">
            </x-perks-card>
        </div>
    </div>
    {{-- Programs --}}
    <div class="h-fit my-10">
        ...
        <div class="grid gap-x-2 gap-y-6 grid-cols-3">
            <div class="text-center">
                <img src="{{ asset('assets/ict.png') }}" class="mx-auto mb-4 w-40 rounded-full shadow-lg" alt="Avatar" />
                <h5 class="mb-2 text-xl font-medium leading-tight">BS Information Systems</h5>
            </div>

            <div class="text-center">
                <img src="{{ asset('assets/jpia.png') }}" class="mx-auto mb-4 w-40 rounded-full shadow-lg" alt="Avatar" />
                <h5 class="mb-2 text-xl font-medium leading-tight">BS Accountancy</h5>
            </div>

            <div class="text-center">
                <img src="{{ asset('assets/bssw.png') }}" class="mx-auto mb-4 w-40 rounded-full shadow-lg" alt="Avatar" />
            ...
            <div class="text-center">
                <img src="{{ asset('assets/bab.png') }}" class="mx-auto mb-4 w-40 rounded-full shadow-lg" alt="Avatar" />
    ...
    <div class="h-64 bg-blue-300 m-10 p-5 rounded-lg sm:h-72 md:h-96">
        <div class="h-full relative grid grid-cols-1 gap-4 content-center w-auto text-center px-5 md:px-10">
            ...
            <div class="text-center flex items-center justify-center">
                <a href="{{ route('register') }}">
                    <div class="w-auto text-center py-2 px-10 font-bold rounded-sm text-sm text-sky-700 hover:text-white transition ease-in-out delay-150 bg-blue-50 hover:-translate-y-1 hover:scale-110 hover:bg-blue-500 duration-300
                    ">
                        APPLY FOR SCHOLARSHIP
                    </div>
                </a>
