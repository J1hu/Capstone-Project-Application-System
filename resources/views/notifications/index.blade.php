<x-app-layout>
    ...
    <form action="{{ route('notifications.notification') }}" method="POST">
        ...
        <div class="bg-white p-5 mt-5">
            <div class="form-group m-1 grid grid-cols-2 space-x-4">
                <div class="grid">
            ...
            <div class="form-group mt-5">
                ...
                <x-trix-field name="content" id="content" class="form-control inline-flex m-1 p-3 leading-5 text-black border-2 rounded-md border-slate-400 bg-white focus:ring-blue-500 focus:border-blue-500" required :initial-value="''" />
            </div>
        </div>
