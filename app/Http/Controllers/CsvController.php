...
class CsvController extends Controller
{
    ...
    public function generateFailedApplicantsCSV()
    {
        // Fetch all data from DB
        $applicants = Applicant::where('applicant_status_id', 3)->get();
        ...
        return $this->generateCSV('failed_applicants_list.csv', $data);
    }
